...
(define (create-view-realistic waterFile elevationFile vegatationFile volcanismFile temperatureFile biomeFile treesFile dirtFile mountainsFile)
...
(script-fu-register
	"create-view-realistic"
	"Create realistic DF map..."                
	"Creates a realistic map from Dwarf Fortress' exported Maps"
...
(script-fu-menu-register "create-view-realistic" "<Image>/File/Create/Dwarf Map")