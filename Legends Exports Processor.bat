...
for %%i in ("%~dp0data\sat_mountains.bmp")  do set sat_mountains=%%~fi
for %%i in ("%~dp0data\sat_trees.bmp")  do set sat_trees=%%~fi
for %%i in ("%~dp0data\sat_dirt.bmp")  do set sat_dirt=%%~fi
